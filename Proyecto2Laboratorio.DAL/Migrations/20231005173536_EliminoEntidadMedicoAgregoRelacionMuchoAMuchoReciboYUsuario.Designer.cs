...
namespace Proyecto2Laboratorio.DAL.Migrations
{
    ...
    [Migration("20231005173536_EliminoEntidadMedicoAgregoRelacionMuchoAMuchoReciboYUsuario")]
    partial class EliminoEntidadMedicoAgregoRelacionMuchoAMuchoReciboYUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Proyecto2Laboratorio.Entities.Turno", b =>
                {
                    b.HasOne("Proyecto2Laboratorio.Entities.EstadoTurno", "EstadoTurno")
                        .WithOne("Turno")
                        .HasForeignKey("Proyecto2Laboratorio.Entities.Turno", "EstadoTurnoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
